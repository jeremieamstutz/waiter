...
export default function DesktopUnavailable({ url }) {
	return (
		<div className={classes.container}>
			<Image
				src={`${process.env.NEXT_PUBLIC_DOMAIN}/api/qrcode?url=${
			...
			<p className={classes.text}>
				Veuillez la consulter depuis un{' '}
				<span style={{ color: '#000' }}>smartphone</span> en scannant le{' '}
				<span style={{ color: '#000' }}>code QR</span> ci-dessus.
			</p>
		</div>
	)
}
